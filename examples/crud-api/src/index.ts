...
import { createApp, serve, cors, security, HttpError } from '@celsian/core';
...
function validateTodoInput(body: unknown): { title: string; description?: string; priority?: string; completed?: boolean } {
  ...
  return { title: title.trim(), description: description as string | undefined, priority: priority as string | undefined, completed: completed as boolean | undefined };
}
