...
const VERCEL_INDEX = `// Generated by: celsian deploy --platform vercel
...
const LAMBDA_HANDLER = `// Generated by: celsian deploy --platform lambda
// Adjust the import path below to match your app's entry point.
...
const CLOUDFLARE_WORKER = `// Generated by: celsian deploy --platform cloudflare
// Adjust the import path below to match your app's entry point.
