...
- **QA test app:** was `examples/qa-test/src/index.ts`; removed 2026-07-26 (an internal harness should not sit in the public examples folder)
- **Benchmark app:** was `examples/qa-test/src/bench.ts`; removed 2026-07-26. Benchmarks live in `benchmarks/`.
